...
// match history of all matches in our database.
    @Override
...
//                update the match in database
    ...
    private void updateMatchInDb(Match match1) {
        ...
        if(match==null){
            ...
            // if match is there we have to update by setting ID of existing one to new one and updating it
    ...
    public List<List<String>> getPointsTable() {
        ...
        try {
            ...
            // select("thead>tr>*") is a CSS selector that targets all child elements (*) of each <tr> element
            // within the <thead> section of the table.
